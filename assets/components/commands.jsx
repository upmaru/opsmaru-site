...
const tabs = [
  {
    ...
    2024-12-09 03:18:22.675984193  03:18:22.675 [info] {"args":{"insterra_component_id":464,"organization_id":2,"type":"storage","uid":520},"id":3123652,"meta":{},"system_time":1733714302675160306,"max_attempts":2,"queue":"insterra","worker":"Instellar.Insterra.Blueprints.Component.Registration","source":"oban","event":"job:start","attempt":1,"tags":[]}
    2024-12-09 03:18:22.684365108  03:18:22.681 request_id=GA9j-P5xLntPnIwAAAni [info] Sent 201 in 49ms
    2024-12-09 03:18:22.744414543  03:18:22.743 [info] {"args":{"insterra_component_id":464,"organization_id":2,"type":"storage","uid":520},"id":3123652,"meta":{},"state":"success","max_attempts":2,"queue":"insterra","worker":"Instellar.Insterra.Blueprints.Component.Registration","source":"oban","event":"job:stop","duration":63570,"attempt":1,"tags":[],"queue_time":18250}
    2024-12-09 03:18:33.073159823  03:18:33.072 [info] {"args":{"storage_id":520,"user_id":12},"id":3123653,"meta":{},"system_time":1733714313072278916,"max_attempts":2,"queue":"infrastructures","worker":"Instellar.Infrastructures.Storage.Litmus","source":"oban","event":"job:start","attempt":1,"tags":[]}
    2024-12-09 03:18:33.796689036  03:18:33.796 [info] {"error":"** (Oban.PerformError) Instellar.Infrastructures.Storage.Litmus failed with {:error, {:http_error, 403, %{body: \"<?xml version=\\\"1.0\\\" encoding=\\\"UTF-8\\\"?>\\n<Error><Code>AccessDenied</Code><Message>User: arn:aws:iam::230851414739:user/instellar/artello-storage-infra-user is not authorized to perform: kms:GenerateDataKey on resource: arn:aws:kms:ap-southeast-1:230851414739:key/191c120f-830a-4333-81dd-74e59a478a96 because no identity-based policy allows the kms:GenerateDataKey action</Message><RequestId>FP6W04AHFCTAG3Y6</RequestId><HostId>4hVtdhasF8grFdwBmNN9DChag9GoVgViVSXdmzDpGgQHtevTSCV6M8jbDE+gZFxDHB81jb5CIrZsPdLrB4+iRvspehsZHvVhSTbJjcATH28=</HostId></Error>\", headers: [{\"x-amz-request-id\", \"FP6W04AHFCTAG3Y6\"}, {\"x-amz-id-2\", \"4hVtdhasF8grFdwBmNN9DChag9GoVgViVSXdmzDpGgQHtevTSCV6M8jbDE+gZFxDHB81jb5CIrZsPdLrB4+iRvspehsZHvVhSTbJjcATH28=\"}, {\"Content-Type\", \"application/xml\"}, {\"Transfer-Encoding\", \"chunked\"}, {\"Date\", \"Mon, 09 Dec 2024 03:18:33 GMT\"}, {\"Server\", \"AmazonS3\"}], status_code: 403}}}","args":{"storage_id":520,"user_id":12},"id":3123653,"meta":{},"state":"failure","max_attempts":2,"queue":"infrastructures","worker":"Instellar.Infrastructures.Storage.Litmus","source":"oban","event":"job:exception","duration":711612,"attempt":1,"tags":[],"queue_time":387137}
    2024-12-09 03:18:52.257308189  03:18:52.256 [info] {"args":{"storage_id":520,"user_id":12},"id":3123653,"meta":{},"system_time":1733714332256079090,"max_attempts":2,"queue":"infrastructures","worker":"Instellar.Infrastructures.Storage.Litmus","source":"oban","event":"job:start","attempt":2,"tags":[]}
    2024-12-09 03:18:53.455292187  03:18:53.454 [info] {"args":{"storage_id":520,"user_id":12},"id":3123653,"meta":{},"state":"success","max_attempts":2,"queue":"infrastructures","worker":"Instellar.Infrastructures.Storage.Litmus","source":"oban","event":"job:stop","duration":1194142,"attempt":2,"tags":[],"queue_time":467602}
...
export function Commands() {
  ...
  return (
    <div className="flex px-10 gap-x-4 mt-4">
      ...
      {tabs.map((tab, index) => 
      <button key={`demo-${index}`} onClick={() => setActiveTab(index) } data-active={activeTab === index} className="text-left border border-slate-700 rounded-lg px-4 py-4 z-10 bg-slate-800 hover:bg-slate-700 hover:border-slate-400 data-[active=true]:bg-slate-500 data-[active=true]:border-white">
