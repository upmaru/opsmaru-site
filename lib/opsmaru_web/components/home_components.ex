      ...
      <div id="slides" class="h-[300vh] bg-gradient-to-b from-slate-950 from-50% to-slate-900 relative" phx-hook="MountSlideScroll">
        <div id="slides-container" class="flex sticky top-0">
          <div :for={slide <- @slides} class="slide-item flex flex-col flex-none items-center justify-center w-screen h-screen overflow-hidden">
            <h2 class="slide-title bg-gradient-to-r from-cyan-300 from-[28%] via-purple-400 via-[70%] to-violet-600 font-semibold text-transparent bg-clip-text text-6xl p-2"><%= slide.title %></h2>
            <div class="slide-description rounded-full mb-24">
              <p class="text-white font-light text-center text-4xl font-light"><%= slide.subtitle %></p>
            </div>
